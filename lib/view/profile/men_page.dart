...
class Men_Products extends StatefulWidget {
  const Men_Products({super.key});

  @override
  State<Men_Products> createState() => _Men_ProductsState();
}

class _Men_ProductsState extends State<Men_Products> {
  late Future<List<Product>> allProducts;
